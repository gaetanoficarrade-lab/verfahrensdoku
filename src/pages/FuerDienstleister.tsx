            ...
            <div className="grid md:grid-cols-2 gap-6 items-stretch">
              ...
              <Reveal>
                <div className="rounded-[18px] p-8 flex flex-col h-full" style={{ background: C.white, boxShadow: '0 2px 16px rgba(0,0,0,0.06)' }}>
                  ...
                  <a href={annual ? "https://funnelpay.de/checkout/GoBD-Suite Berater Plan Jährl." : "https://funnelpay.de/checkout/test--GoBD-Suite Berater Plan"} target="_blank" rel="noopener noreferrer"
