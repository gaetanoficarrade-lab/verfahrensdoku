        ...
        <div className="space-y-10 text-[15px] leading-relaxed text-[#1d1d1f]">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-1">
              ...
              <li>Betriebliche Daten zur Buchführung und IT-Infrastruktur, soweit im Rahmen der Verfahrensdokumentation erfasst</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Personenbezogene Daten nur auf dokumentierte Weisung des Verantwortlichen zu verarbeiten (Art. 28 Abs. 3 lit. a DSGVO).</li>
              <li>Sicherzustellen, dass sich die zur Verarbeitung befugten Personen zur Vertraulichkeit verpflichtet haben (Art. 28 Abs. 3 lit. b DSGVO).</li>
              ...
              <li>Dem Verantwortlichen alle erforderlichen Informationen zum Nachweis der Einhaltung der DSGVO zur Verfügung zu stellen und Überprüfungen zu ermöglichen.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Zutrittskontrolle:</strong> Server-Hosting bei Netcup in deutschen Rechenzentren mit physischer Zugangskontrolle.</li>
              <li><strong>Zugangskontrolle:</strong> Authentifizierung über sichere Auth-Systeme mit Passwort-Hashing, optionale Multi-Faktor-Authentifizierung.</li>
              <li><strong>Zugriffskontrolle:</strong> Row-Level-Security in der Datenbank, rollenbasierte Berechtigungen, vollständige Mandantentrennung.</li>
              <li><strong>Verschlüsselung:</strong> TLS/SSL-Verschlüsselung für alle Datenübertragungen, Verschlüsselung sensibler Daten at rest.</li>
              <li><strong>Verfügbarkeitskontrolle:</strong> Redundante Infrastruktur, regelmäßige Backups, Systemmonitoring.</li>
              <li><strong>Trennungskontrolle:</strong> Mandantenfähiges System mit vollständiger Datentrennung zwischen allen Nutzerkonten.</li>
              <li><strong>Auditierbarkeit:</strong> Revisionssichere Versionierung aller Dokumentänderungen mit Änderungshistorie und Zeitstempel.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">7.1 Nach Beendigung des Hauptvertrags löscht der Auftragsverarbeiter alle im Auftrag verarbeiteten personenbezogenen Daten, sofern keine gesetzlichen Aufbewahrungspflichten entgegenstehen.</p>
            <p className="mb-2">7.2 Der Verantwortliche kann seine Daten innerhalb von 30 Tagen nach Vertragsbeendigung in einem gängigen Format exportieren.</p>
          ...
          <section>
            ...
            <p className="mb-2">8.1 Der Verantwortliche hat das Recht, die Einhaltung der vereinbarten technischen und organisatorischen Maßnahmen sowie der Bestimmungen dieses AVV zu überprüfen. Der Auftragsverarbeiter stellt die hierfür erforderlichen Informationen zur Verfügung.</p>
            <p className="mb-2">8.2 Inspektionen und Audits sind mit einer Vorankündigungsfrist von mindestens 14 Tagen und unter Wahrung der Geschäftsgeheimnisse durchzuführen.</p>
            <p>8.3 Der Auftragsverarbeiter kann den Nachweis der Einhaltung auch durch Vorlage geeigneter Zertifizierungen oder Prüfberichte erbringen.</p>
          </section>
