...
export default function Datenschutz() {
  useSEO({
    title: "Datenschutzerklärung | GoBD-Suite",
        ...
        <div className="space-y-10 text-[#86868b] leading-relaxed">
          <section>
            ...
            <p>
              ...
              passiert, wenn du diese Website besuchst. Personenbezogene Daten sind alle Daten, mit denen du persönlich
          ...
          <section>
            ...
            <p>
              Beim Besuch unserer Website werden automatisch folgende Daten erfasst: IP-Adresse, Datum und Uhrzeit der
              Anfrage, Zeitzonendifferenz zur GMT, Inhalt der Anforderung (besuchte Seite), HTTP-Statuscode, übertragene
              Datenmenge, Referrer-URL, Browser und Betriebssystem.
            </p>
            <p className="mt-2">
              <strong className="text-[#1d1d1f]">Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. f DSGVO (berechtigtes
              Interesse an der sicheren und effizienten Bereitstellung der Website).
            </p>
            <p className="mt-2">
              <strong className="text-[#1d1d1f]">Speicherdauer:</strong> Server-Logfiles werden nach 30 Tagen
              automatisch gelöscht.
            </p>

            <h3 className="text-lg font-semibold text-[#1d1d1f] mt-6 mb-2">b) Registrierung und Nutzerkonto</h3>
            <p>
              Bei der Registrierung erheben wir: E-Mail-Adresse, Passwort (verschlüsselt gespeichert), Unternehmensname
              und Kontaktdaten.
            </p>
            <p className="mt-2">
              <strong className="text-[#1d1d1f]">Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. b DSGVO
              (Vertragserfüllung).
            </p>
            <p className="mt-2">
              <strong className="text-[#1d1d1f]">Speicherdauer:</strong> Bis zur Löschung des Nutzerkontos bzw. 30 Tage
              nach Vertragsbeendigung (Export-Frist gemäß AGB).
            </p>
            ...
            <p>
              Berater und Agenturen verarbeiten über den Dienst personenbezogene Daten ihrer Kunden (Stammdaten,
              Onboarding-Informationen). In diesem Fall agieren wir als Auftragsverarbeiter gemäß Art. 28 DSGVO. Details
              regelt der gesonderte{" "}
              <Link to="/avv" className="text-[#e8a91a] hover:text-[#d49b15] underline">
          ...
          <section>
            ...
            <p>
              Cookies sind kleine Textdateien, die auf deinem Endgerät gespeichert werden. Wir verwenden außerdem den
              localStorage deines Browsers, um funktionsrelevante Daten zu speichern.
            </p>
            ...
            <p>
              ...
              ausdrücklich zustimmst (Opt-in). Rechtsgrundlage: Art. 6 Abs. 1 lit. a DSGVO (Einwilligung). Du kannst
              deine Einwilligung jederzeit über den Link „Cookie-Einstellungen" im Footer widerrufen.
            </p>
            <p className="mt-2">Wir nutzen aktuell keine Analyse- oder Marketing-Cookies.</p>
          </section>
          ...
          <section>
            ...
            <p>
              Das Hosting der Anwendung erfolgt bei Netcup GmbH auf Servern in deutschen Rechenzentren. Die
              Infrastruktur umfasst Self-hosted Supabase (Datenbank, Authentifizierung, Edge Functions).
            </p>
            <p className="mt-2">
              <strong className="text-[#1d1d1f]">Standort:</strong> Deutschland
              <br />
              <strong className="text-[#1d1d1f]">Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. f DSGVO (berechtigtes
              Interesse)
            </p>
            ...
            <p className="mt-2">
              <strong className="text-[#1d1d1f]">Standort:</strong> USA
              <br />
              <strong className="text-[#1d1d1f]">Garantien:</strong> EU-US Data Privacy Framework (DPF) und
            ...
            <p>Für den Versand transaktionaler E-Mails (Einladungen, Statusmeldungen) nutzen wir Resend, Inc.</p>
            <p className="mt-2">
              <strong className="text-[#1d1d1f]">Standort:</strong> USA
              <br />
              <strong className="text-[#1d1d1f]">Garantien:</strong> EU-US Data Privacy Framework (DPF)
              <br />
              <strong className="text-[#1d1d1f]">Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. b DSGVO
              (Vertragserfüllung)
            </p>
            ...
            <p>
              Für die Zahlungsabwicklung nutzen wir Funnelpay bzw. Stripe. Diese Anbieter verarbeiten deine
              Zahlungsdaten gemäß deren eigenen Datenschutzbestimmungen.
            </p>
            <p className="mt-2">
              <strong className="text-[#1d1d1f]">Standort:</strong> EU
              <br />
              <strong className="text-[#1d1d1f]">Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. b DSGVO
              (Vertragserfüllung)
            </p>
          ...
          <section>
            ...
            <p>
              Wir laden keine Schriftarten, Skripte oder Medien von externen Servern (z.B. Google Fonts, Google
              Analytics, Facebook Pixel, YouTube). Alle Schriftarten sind lokal auf unserem Server gespeichert. Externe
              Dienste wie Analyse- oder Marketing-Tools werden nur mit deiner ausdrücklichen Einwilligung aktiviert.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1.5">
              <li>
                <strong className="text-[#1d1d1f]">Auskunftsrecht</strong> (Art. 15 DSGVO) – Welche Daten wir über dich
                gespeichert haben
              </li>
              <li>
                <strong className="text-[#1d1d1f]">Berichtigung</strong> (Art. 16 DSGVO) – Korrektur unrichtiger Daten
              </li>
              <li>
                <strong className="text-[#1d1d1f]">Löschung</strong> (Art. 17 DSGVO) – Löschung deiner Daten („Recht auf
                Vergessenwerden")
              </li>
              <li>
                <strong className="text-[#1d1d1f]">Einschränkung</strong> (Art. 18 DSGVO) – Einschränkung der
                Verarbeitung
              </li>
              <li>
                <strong className="text-[#1d1d1f]">Datenübertragbarkeit</strong> (Art. 20 DSGVO) – Export deiner Daten
                in einem gängigen Format
              </li>
              <li>
                <strong className="text-[#1d1d1f]">Widerspruch</strong> (Art. 21 DSGVO) – Widerspruch gegen die
                Verarbeitung
              </li>
              <li>
                <strong className="text-[#1d1d1f]">Widerruf der Einwilligung</strong> (Art. 7 Abs. 3 DSGVO) – Jederzeit
