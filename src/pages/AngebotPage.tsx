  ...
  return (
    <Link to={CTA_URL}>
      <button
        ...
        onMouseOver={(e) => {
          (e.target as HTMLElement).style.background = goldLight;
        }}
        onMouseOut={(e) => {
...
export default function AngebotPage() {
  ...
  const applicationSchema = {
    ...
    name: "GoBD-Suite",
    description: "Plattform zur Erstellung GoBD-konformer Verfahrensdokumentationen für Dienstleister und Berater",
    url: "https://gobd-suite.de/angebot",
  ...
  return (
    <div style={{ color: dark }} className="min-h-screen antialiased selection:bg-[#e8a91a]/20">
      ...
      <nav
        ...
        style={{ background: `${white}E6`, borderColor: "#e5e5e5" }}
      >
      ...
      <Section className="pt-32 pb-20 sm:pt-44 sm:pb-32" variant="white" id="hero">
        <M className="max-w-3xl">
          ...
          <h1
            className="text-3xl sm:text-5xl lg:text-[3.5rem] font-bold leading-[1.08] tracking-tight mb-6"
            style={{ color: dark }}
          >
          ...
          <CtaButton large />
          <p className="mt-4 text-xs font-medium" style={{ color: warmGray }}>
      ...
      <Section className="py-24 sm:py-32" variant="light" id="konflikt">
        <M>
          <h2
            className="text-2xl sm:text-4xl lg:text-[2.75rem] font-bold mb-5 text-center leading-tight"
            style={{ color: dark }}
          >
            Seit 2025 prüft das Finanzamt aktiv.
          </h2>
          <p
            className="text-center text-lg sm:text-xl max-w-2xl mx-auto mb-16"
            style={{ color: warmGray, lineHeight: 1.7 }}
          >
            Ohne ordnungsgemäße Verfahrensdokumentation drohen Bußgelder bis zu 25.000&nbsp;Euro, Hinzuschätzungen durch
            das Finanzamt und im schlimmsten Fall die Verwerfung der gesamten Buchführung.
          </p>
        </M>
        <motion.div variants={stagger} className="grid sm:grid-cols-3 gap-6">
          {[
            {
              icon: Euro,
              title: "Bußgeld bis 25.000 €",
              text: "Bei fehlender oder mangelhafter Verfahrensdokumentation drohen empfindliche Geldbußen.",
            },
            {
              icon: AlertTriangle,
              title: "Hinzuschätzung",
              text: "Das Finanzamt schätzt Umsätze und Gewinne – meist zu Ungunsten deines Kunden.",
            },
            {
              icon: FileX,
              title: "Buchführungsverwerfung",
              text: "Im schlimmsten Fall wird die gesamte Buchführung verworfen und neu geschätzt.",
            },
            ...
            <M key={title}>
              <div className="rounded-2xl p-7 h-full bg-white border border-[#e5e5e5] hover:shadow-md transition-shadow duration-300">
                ...
                <h3 className="font-semibold text-lg mb-2" style={{ color: dark }}>
                  {title}
                </h3>
                <p className="text-sm leading-relaxed" style={{ color: warmGray }}>
                  {text}
                </p>
              </div>
            </M>
      ...
      <Section className="py-24 sm:py-32" variant="dark" id="tool">
        <M className="text-center mb-14 max-w-3xl mx-auto">
          <h2 className="text-2xl sm:text-4xl lg:text-[2.75rem] font-bold mb-5 leading-tight" style={{ color: white }}>
            GoBD-Suite gibt dir das <span style={{ color: gold }}>komplette Werkzeug.</span>
          </h2>
          <p className="text-lg max-w-2xl mx-auto" style={{ color: "#a1a1a6" }}>
            Das einzige Tool im DACH-Raum für vollständige, prüfungssichere Verfahrensdokumentationen – in unter einer
            Stunde, unter deinem Brand.
          </p>
        </M>
        <M>
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="text-center">
                ...
                <p className="font-medium" style={{ color: "#a1a1a6" }}>
                  Demo ansehen – 4 Minuten
                </p>
              </div>
            </div>
          </div>
      ...
      <Section className="py-24 sm:py-32" variant="white" id="schritte">
        <M className="text-center mb-16">
          <h2 className="text-2xl sm:text-4xl lg:text-[2.75rem] font-bold leading-tight" style={{ color: dark }}>
            In 3 Schritten zur fertigen <span style={{ color: gold }}>Verfahrensdokumentation</span>
          </h2>
        </M>
          ...
          {[
            {
              ...
              text: "Kunden anlegen und per Link ins Portal einladen. Der Kunde beschreibt seine Prozesse selbst – keine Fachkenntnisse nötig.",
            },
            {
              num: "02",
              icon: Sparkles,
              title: "KI erstellt Kapitel",
              text: "Die KI erstellt automatisch alle relevanten Kapitel. Du prüfst, passt an, finalisierst.",
            },
            {
              num: "03",
              icon: Download,
              title: "PDF exportieren",
              text: "Ein Klick – professionelles PDF mit deinem Logo. Prüfungssicher, revisionssicher, sofort lieferbar.",
            },
          ].map(({ num, icon: Icon, title, text }) => (
            <M key={num}>
              <div className="text-center">
                <span className="text-6xl font-black tracking-tight" style={{ color: `${gold}25` }}>
                  {num}
                </span>
                <div
                  className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mt-3 mb-5"
      ...
      <Section className="py-24 sm:py-32" variant="light" id="faq">
        ...
        <M className="max-w-2xl mx-auto">
          <Accordion type="single" collapsible className="space-y-3">
            {[
              {
                q: "Ich habe keine Ahnung von GoBD.",
                a: "Das Tool führt dich durch jeden Schritt. Du brauchst kein Vorwissen – das System erkennt automatisch, welche Kapitel relevant sind.",
              },
              {
                q: "Rechnet sich das wirklich?",
                a: "Eine VD kostet deinen Kunden 800 bis 2.500 Euro. Du zahlst 399 Euro im Monat. Nach dem ersten Kunden bist du im Plus.",
              },
              {
                q: "Was wenn sich Gesetze ändern?",
                a: "Das Tool wird laufend aktualisiert. Du musst nichts selbst im Blick behalten.",
              },
              {
                q: "Ich habe schon genug Tools.",
                a: "GoBD-Suite ist kein zusätzlicher Aufwand – es ist eine neue Einnahmequelle, die sich in deinen bestehenden Workflow einfügt.",
              },
            ].map(({ q, a }, i) => (
              <AccordionItem
                key={i}
              ...
              >
                ...
                <AccordionContent>
                  <p className="pb-3 leading-relaxed text-sm" style={{ color: warmGray }}>
                    {a}
                  </p>
                </AccordionContent>
              </AccordionItem>
      ...
      <Section className="py-24 sm:py-32" variant="white" id="trust">
        ...
        <M>
          <div
            className="rounded-2xl p-10 text-center border border-dashed border-[#d1d1d6]"
            style={{ background: lightBg }}
          >
            <p className="italic text-lg" style={{ color: warmGray }}>
              "Testimonial folgt"
            </p>
            <p className="text-sm mt-2" style={{ color: "#c7c7cc" }}>
      ...
      <Section className="py-24 sm:py-32" variant="dark" id="transformation">
        <M className="text-center mb-16">
          <h2
            className="text-2xl sm:text-4xl lg:text-[2.75rem] font-bold leading-tight max-w-3xl mx-auto"
            style={{ color: white }}
          >
        ...
        <motion.div variants={stagger} className="grid sm:grid-cols-2 gap-6">
          ...
          <M>
            <div className="rounded-2xl p-8 h-full" style={{ background: "#2a2a2c", border: "1px solid #3a3a3c" }}>
              <h3 className="font-bold text-lg mb-6" style={{ color: "#ff6b6b" }}>
                Ohne GoBD-Suite
              </h3>
              <ul className="space-y-4">
                {[
                  "Manuelle Erstellung in Word",
                  "40+ Stunden pro Dokument",
                  "Kein skalierbares Angebot möglich",
          ...
          <M>
            <div className="rounded-2xl p-8 h-full" style={{ background: "#2a2a2c", border: `1px solid ${gold}44` }}>
              <h3 className="font-bold text-lg mb-6" style={{ color: gold }}>
                Mit GoBD-Suite
              </h3>
              <ul className="space-y-4">
                {[
                  "KI-gestützte Erstellung",
                  "Unter einer Stunde pro VD",
                  "Skalierbares Angebot für alle Kunden",
      ...
      <Section className="py-24 sm:py-32" variant="white" id="pricing">
        <M className="text-center mb-14">
          <h2 className="text-2xl sm:text-4xl lg:text-[2.75rem] font-bold" style={{ color: dark }}>
            Teste GoBD-Suite <span style={{ color: gold }}>7 Tage kostenlos.</span>
          </h2>
        ...
        <M className="flex justify-center">
          <div className="rounded-3xl p-9 sm:p-12 w-full max-w-md bg-[#faf9f6] border border-[#e5e5e5] shadow-sm">
            <p className="text-xs font-bold uppercase tracking-[0.15em] mb-2" style={{ color: gold }}>
              Berater-Plan
            </p>
            <div className="flex items-end gap-1 mb-7">
              <span className="text-5xl font-black tracking-tight" style={{ color: dark }}>
                399&nbsp;€
              </span>
              <span className="text-lg mb-1 font-medium" style={{ color: warmGray }}>
                /Monat
              </span>
            </div>
      ...
      <Section className="py-20 sm:py-24" variant="light" id="footer-cta">
        ...
        <div className="border-t pt-8 text-center text-sm" style={{ borderColor: "#e5e5e5", color: warmGray }}>
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <Link to="/impressum" className="hover:underline" style={{ color: warmGray }}>
              Impressum
            </Link>
            <span>|</span>
            <Link to="/datenschutz" className="hover:underline" style={{ color: warmGray }}>
              Datenschutz
            </Link>
            <span>|</span>
