...
const PLANS = {
  ...
  berater: { label: "Berater", priceMonthly: 399, priceYearly: 3990, provisionMonthly: 59.85, provisionYearly: 598.5 },
  agentur: {
    label: "Agentur",
    priceMonthly: 799,
    priceYearly: 7990,
    provisionMonthly: 119.85,
    provisionYearly: 1198.5,
  },
} as const;
    ...
    <div className="rounded-[18px] p-8 md:p-10 max-w-2xl mx-auto" style={glass}>
      <div className="mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          />
          <span className="text-2xl font-bold min-w-[3ch] text-right" style={{ color: C.dark }}>
            {customers}
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center p-4 rounded-xl" style={{ background: "rgba(250,200,30,0.1)" }}>
          <p className="text-xs font-medium mb-1" style={{ color: C.textGray }}>
            Erster Monat
          </p>
...
function ApplicationForm() {
  ...
  if (submitted) {
    return (
      <div className="rounded-[18px] p-10 text-center" style={glass}>
        ...
        <h3 className="text-2xl font-bold mb-3" style={{ color: C.dark }}>
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-[18px] p-8 md:p-10 max-w-2xl mx-auto" style={glass}>
      ...
      <div className="mb-4">
        <label className="block text-sm font-semibold mb-1.5" style={{ color: C.dark }}>
          Wie planst du GoBD-Suite zu empfehlen? *
        </label>
        <select
      ...
      <div className="mb-6">
        ...
        <textarea
          ...
          value={form.audience}
          onChange={(e) => setForm((f) => ({ ...f, audience: e.target.value.slice(0, 300) }))}
          maxLength={300}
          placeholder="Max. 300 Zeichen"
        />
        <p className="text-xs mt-1" style={{ color: C.textGray }}>
          {form.audience.length}/300
        </p>
      </div>
...
export default function PartnerPage() {
  useSEO({
    ...
    description:
      "Werde GoBD-Suite Partner und verdiene dauerhaft Provision auf jeden Kunden den du vermittelst. 15% Provision – monatlich, solange der Kunde zahlt. Nach oben keine Grenze.",
    canonical: "https://gobd-suite.de/partner",
    robots: "index, follow",
    ogTitle: "Partner werden – GoBD-Suite Affiliate-Programm | 15% Provision",
    ogDescription:
      "Werde GoBD-Suite Partner und verdiene dauerhaft Provision auf jeden vermittelten Kunden – 15% monatlich, keine Zeitlimit, keine Deckelung.",
    ogImage: "https://gobd-suite.de/og-partner.png",
    ogUrl: "https://gobd-suite.de/partner",
    ogType: "website",
    ogLocale: "de_DE",
  ...
  // Zusätzliches JSON-LD Schema für das Affiliate-Programm
  const affiliateSchema = {
    "@context": "https://schema.org",
    "@type": "SoftwareApplication",
    name: "GoBD-Suite Affiliate-Programm",
    description: "Verdiene dauerhaft 15% Provision auf jeden vermittelten Kunden – solange der Kunde GoBD-Suite nutzt.",
    url: "https://gobd-suite.de/partner",
    applicationCategory: "BusinessApplication",
    offers: {
      "@type": "AggregateOffer",
      priceCurrency: "EUR",
      description: "15% Provision dauerhaft, ohne Zeitlimit und Deckelung",
    },
  };

  return (
    <div className="min-h-screen" style={{ background: C.white, color: C.dark }}>
      <script type="application/ld+json">{JSON.stringify(affiliateSchema)}</script>
      <MarketingNav />
      ...
      <main>
        ...
        <section className="pt-32 md:pt-44 pb-20 md:pb-28 px-6 text-center" style={{ background: C.white }}>
          <div className="max-w-4xl mx-auto" style={{ animation: "heroSlideUp 0.8s ease-out" }}>
            ...
            <h1
              className="text-4xl md:text-[56px] font-bold leading-[1.08] tracking-tight mb-6"
              style={{ color: C.dark }}
            >
              Verdiene dauerhaft Geld mit <span style={{ color: C.yellow }}>GoBD-Suite</span> – solange dein Kunde
              zahlt.
            </h1>
            <p className="text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10" style={{ color: C.textGray }}>
              Empfiehl GoBD-Suite und erhalte 15% Provision auf jeden Kunden – monatlich oder jährlich. Solange der
              Kunde Kunde ist, verdienst du mit. Nach oben gibt es keine Grenze.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <a
                href="https://affiliatespot.de/gobd-suite/register"
                target="_blank"
              ...
              {[
                ...
                <div key={i} className="flex items-center gap-10 md:gap-16">
                  <div className="text-center">
                    <p className="text-2xl md:text-3xl font-bold mb-1.5 tracking-tight" style={{ color: C.yellow }}>
                      {s.value}
                    </p>
                    <p className="text-xs md:text-sm leading-snug" style={{ color: C.textGray }}>
                      {s.label}
                    </p>
                  </div>
                  {i < arr.length - 1 && (
              ...
              {[
                {
                  ...
                  desc: "Jedes Unternehmen das digital bucht braucht eine Verfahrensdokumentation. Der Markt ist riesig – und kaum abgedeckt.",
                },
                {
                  icon: <RefreshCw size={28} />,
                  title: "Recurring Revenue",
                  desc: "Deine Kunden zahlen monatlich oder jährlich. Du verdienst solange sie dabei bleiben – ohne weiteren Aufwand.",
                },
                {
                  icon: <Euro size={28} />,
                  title: "Hohe Provisionen",
                  desc: "Bei einem Agentur-Kunden verdienst du 119,85€ pro Monat – dauerhaft. Je mehr Kunden du vermittelst, desto mehr verdienst du. Nach oben gibt es keine Grenze.",
                },
                {
                  icon: <Users size={28} />,
                  title: "Riesige Zielgruppe",
                  desc: "Selbstständige, Freelancer, Steuerberater, Berater, Agenturen – jeder der digital bucht ist ein potenzieller Kunde.",
                },
              ].map((card, i) => (
                <Reveal key={i} delay={i * 0.1}>
                  <div className="rounded-[18px] p-7 h-full" style={glass}>
                    ...
                    <p className="text-sm leading-relaxed" style={{ color: C.textGray }}>
                      {card.desc}
                    </p>
                  </div>
                </Reveal>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-14">
              {[
                ...
                {
                  title: "Der Berater",
                  desc: "3 Berater-Kunden pro Monat",
                  amount: "179,55€/Monat dauerhaft\n= 2.154,60€/Jahr",
                  highlight: true,
                },
                {
                  title: "Der Profi",
                  desc: "10 Agentur-Kunden",
                  amount: "1.198,50€/Monat dauerhaft\n= 14.382€/Jahr",
                  highlight: false,
                },
              ].map((card, i) => (
                <Reveal key={i} delay={i * 0.1}>
                  <div
                    className="rounded-[18px] p-7 h-full text-center"
                    style={{
                      ...(card.highlight
                        ? {
                            ...glass,
                            border: `2px solid ${C.yellow}`,
                            background: "rgba(250,200,30,0.06)",
                          }
                        : glass),
                    }}
                  >
                    ...
                    <p className="text-sm mb-4" style={{ color: C.textGray }}>
                      {card.desc}
                    </p>
                    <p className="text-lg font-bold whitespace-pre-line" style={{ color: C.dark }}>
                      {card.amount}
                    </p>
                  </div>
                </Reveal>
              ...
              {[
                {
                  ...
                  desc: "Bewirb dich über das Formular. Wir prüfen deine Anfrage und schalten dich innerhalb von 48 Stunden frei.",
                },
                {
                  step: "2",
                  title: "Deinen Link teilen",
                  desc: "Du registrierst dich im Affiliate-Portal und bekommst sofort deinen persönlichen Tracking-Link. Teile ihn wo du willst – auf deiner Website, in E-Mails, in sozialen Medien.",
                },
                {
                  step: "3",
                  title: "Kunden gewinnen",
                  desc: "Jeder der über deinen Link kauft wird dir dauerhaft zugeordnet. Du siehst alle Klicks und Conversions in Echtzeit.",
                },
                {
                  step: "4",
                  title: "Provision erhalten",
                  desc: "Deine Provision wird automatisch berechnet und monatlich ausgezahlt. Solange dein Kunde zahlt, verdienst du.",
                },
              ].map((s, i) => (
                <Reveal key={i} delay={i * 0.1}>
                  ...
                  <table className="w-full text-left text-sm">
                    <thead>
                      <tr style={{ background: "rgba(250,200,30,0.15)" }}>
                        <th className="px-6 py-4 font-semibold" style={{ color: C.dark }}>
                          Plan
                        </th>
                        <th className="px-6 py-4 font-semibold" style={{ color: C.dark }}>
                          Preis
                        ...
                        <tr key={i} style={{ borderTop: `1px solid ${C.border}` }}>
                          {row.map((cell, j) => (
                            <td
                              key={j}
                              className="px-6 py-4"
                              style={{ color: j === 2 ? C.dark : C.textGray, fontWeight: j === 2 ? 600 : 400 }}
                            >
                              {cell}
                            </td>
                          ))}
            ...
            <Reveal delay={0.1}>
              <div>
                <FaqItem
                  ...
                  a="Fülle das Bewerbungsformular aus. Wir prüfen deine Anfrage und melden uns innerhalb von 48 Stunden. Nach der Freischaltung bekommst du sofort deinen persönlichen Affiliate-Link."
                />
                <FaqItem
                  q="Wie lange läuft meine Provision?"
                  a="Dauerhaft – solange dein vermittelter Kunde GoBD-Suite nutzt und zahlt. Es gibt kein Zeitlimit und keine Deckelung nach oben."
                />
                <FaqItem
                  q="Wann und wie werde ich ausgezahlt?"
                  a="Die Auszahlung erfolgt monatlich auf dein hinterlegtes Konto. Alle Conversions und Provisionen siehst du jederzeit in deinem Affiliate-Dashboard."
                />
                <FaqItem
                  q="Was passiert wenn ein Kunde kündigt?"
                  a="Wenn ein Kunde sein Abonnement beendet, endet auch die Provision für diesen Kunden. Für alle anderen aktiven Kunden läuft sie weiter."
                />
                <FaqItem
                  q="Gibt es eine Mindestprovision für die Auszahlung?"
                  a="Die Mindestauszahlung beträgt 50€. Kleinere Beträge werden auf den nächsten Monat übertragen."
                />
              </div>
            </Reveal>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <Reveal>
              ...
              <p className="text-lg mb-10" style={{ color: C.textGray }}>
                Registriere dich kostenlos im Affiliate-Portal und starte sofort. Keine Wartezeit, keine Genehmigung
                nötig.
              </p>
            </Reveal>
            <Reveal delay={0.1}>
        ...
        <div className="max-w-6xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/#funktionen" className="hover:text-white transition-colors">
                  Funktionen
                </Link>
              </li>
              <li>
                <Link to="/#preise" className="hover:text-white transition-colors">
                  Preise
                </Link>
              </li>
              <li>
