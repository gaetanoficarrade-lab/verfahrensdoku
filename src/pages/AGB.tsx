...
export default function AGB() {
  ...
  const List = ({ items }: { items: string[] }) => (
    <ul className="list-disc pl-8 mb-2 space-y-1">{items.map((t, i) => <li key={i}>{t}</li>)}</ul>
  );
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-[15px] leading-relaxed text-[#1d1d1f]">
          <S title="§ 1 Geltungsbereich und Vertragsparteien">
            <P>1.1 Diese Allgemeinen Geschäftsbedingungen gelten für alle Verträge über die Nutzung der SaaS-Plattform GoBD-Suite, die zwischen</P>
            ...
            <P>1.2 Der Dienst richtet sich ausschließlich an Unternehmer im Sinne des § 14 BGB, d.&nbsp;h. natürliche oder juristische Personen sowie rechtsfähige Personengesellschaften, die bei Abschluss des Vertrages in Ausübung ihrer gewerblichen oder selbständigen beruflichen Tätigkeit handeln.</P>
            <P>1.3 Entgegenstehende oder von diesen AGB abweichende Bedingungen des Kunden werden nicht anerkannt, es sei denn, der Anbieter stimmt ihrer Geltung ausdrücklich schriftlich zu.</P>
          </S>

          <S title="§ 2 Leistungsbeschreibung">
            <P>2.1 GoBD-Suite stellt Unternehmern eine cloudbasierte SaaS-Plattform zur Verfügung, die folgende Kernfunktionen umfasst:</P>
            <List items={[
            ...
            <P>2.4 Der Anbieter ist berechtigt, den Leistungsumfang angemessen zu erweitern, zu ändern oder einzuschränken, sofern dies dem Kunden mindestens 30 Tage vor Inkrafttreten in Textform mitgeteilt wird und die Änderung für den Kunden zumutbar ist.</P>
            <P>2.5 Geplante Wartungsarbeiten werden dem Kunden nach Möglichkeit vorab angekündigt. Der Anbieter strebt eine Verfügbarkeit von 99 % im Jahresmittel an, ausgenommen geplante Wartungsfenster und von Dritten verursachte Ausfälle.</P>
          </S>

          <S title="§ 3 Vertragsschluss und Nutzungskonto">
            <P>3.1 Der Vertrag kommt durch Registrierung auf der Plattform und die Freischaltung des Zugangs durch den Anbieter zustande.</P>
            <P>3.2 Der Kunde ist verpflichtet, bei der Registrierung vollständige und wahrheitsgemäße Angaben zu machen und diese stets aktuell zu halten.</P>
            <P>3.3 Zugangsdaten sind vertraulich zu behandeln und dürfen nicht an Dritte weitergegeben werden. Der Kunde haftet für alle Handlungen, die unter seinem Konto vorgenommen werden, sofern er die unbefugte Nutzung nicht zu vertreten hat.</P>
          ...
          <S title="§ 5 Vergütung und Zahlungsbedingungen">
            ...
            <P>5.2 Plan Solo wird als Einmalbetrag in Rechnung gestellt und gewährt einen Zugang für 12 Monate. Plan Berater und Plan Agentur werden je nach Wahl des Kunden bei Vertragsschluss monatlich oder jährlich im Voraus abgerechnet. Alle Preise verstehen sich als Nettobeträge zuzüglich der gesetzlich geltenden Umsatzsteuer.</P>
          ...
          <S title="§ 6 Testmodus">
            <P>6.1 Der Anbieter stellt auf Wunsch einen kostenlosen Testzugang für 7 Tage zur Verfügung. Der Testzugang ist auf einen Mustermandanten beschränkt, erlaubt die Bearbeitung von maximal zwei Kapiteln und erzeugt PDF-Exporte mit dem Wasserzeichen „MUSTER-VERFAHRENSDOKUMENTATION".</P>
            <P>6.2 Nach Ablauf des Testzeitraums wird der Zugang automatisch gesperrt. Eine Verlängerung des Testzeitraums liegt im Ermessen des Anbieters.</P>
          ...
          <S title="§ 7 Pflichten des Kunden">
            <P>7.1 Der Kunde ist verantwortlich dafür, dass alle von ihm über den Dienst verarbeiteten Daten und Inhalte den geltenden Gesetzen entsprechen.</P>
            <P>7.2 Der Kunde hat den Dienst nicht zu missbrauchen. Untersagt sind insbesondere die Übertragung schädlicher Inhalte, der Aufbau übermäßiger Last sowie der Versuch, unbefugt auf Systeme oder Daten anderer Kunden zuzugreifen.</P>
            <P>7.3 Der Kunde ist allein verantwortlich für die steuerrechtliche Richtigkeit und Vollständigkeit der erstellten Verfahrensdokumentationen. Die durch GoBD-Suite generierten Texte sind auf Basis der Kundenangaben erstellt und stellen eine technische Arbeitshilfe dar. Der Kunde ist verpflichtet, alle generierten Inhalte vor Verwendung zu prüfen und gegebenenfalls anzupassen. GoBD-Suite ersetzt keine steuerliche oder rechtliche Beratung.</P>
          </S>

          <S title="§ 8 Datenschutz und Auftragsverarbeitung">
            <P>8.1 Soweit der Kunde personenbezogene Daten Dritter über den Dienst verarbeitet, agiert der Anbieter als Auftragsverarbeiter im Sinne des Art. 28 DSGVO. Die Parteien schließen zu diesem Zweck einen gesonderten Auftragsverarbeitungsvertrag ab.</P>
            <P>8.2 Der Anbieter verarbeitet personenbezogene Daten des Kunden zur Vertragserfüllung gemäß seiner Datenschutzerklärung, abrufbar unter gaetanoficarra.de/datenschutz.</P>
          ...
          <S title="§ 9 Einsatz von KI-Diensten">
            <P>9.1 Der Dienst nutzt KI-Modelle von OpenAI zur Textgenerierung und Prüfung von Kapitelinhalten. Die generierten Texte werden auf Grundlage der vom Kunden eingegebenen Informationen erstellt.</P>
            <P>9.2 Der Anbieter übernimmt keine Gewähr für die inhaltliche Vollständigkeit oder rechtliche Korrektheit der KI-generierten Texte. Der Kunde ist verpflichtet, die generierten Inhalte vor Verwendung zu prüfen.</P>
          ...
          <S title="§ 10 Vertraulichkeit">
            <P>10.1 Beide Parteien verpflichten sich, alle im Rahmen des Vertragsverhältnisses erlangten vertraulichen Informationen der jeweils anderen Partei vertraulich zu behandeln und nicht an Dritte weiterzugeben.</P>
          ...
          <S title="§ 11 Gewährleistung und Mängelhaftung">
            <P>11.1 Der Anbieter stellt den Dienst in dem zur Vertragszeit üblichen Zustand zur Verfügung. Mängel werden innerhalb angemessener Frist beseitigt.</P>
          ...
          <S title="§ 12 Haftungsbeschränkung">
            <P>12.1 Der Anbieter haftet unbegrenzt für Schäden aus der Verletzung des Lebens, des Körpers oder der Gesundheit sowie für vorsätzlich oder grob fahrlässig verursachte Schäden.</P>
            <P>12.2 Bei einfacher Fahrlässigkeit haftet der Anbieter nur für die Verletzung wesentlicher Vertragspflichten. Die Haftung ist in diesem Fall auf den vertragstypisch vorhersehbaren Schaden begrenzt, maximal auf die Jahresvergütung des Kunden im betreffenden Vertragsjahr.</P>
          ...
          <S title="§ 14 Folgen der Vertragsbeendigung">
            ...
            <P>14.2 Nach Ablauf der Exportfrist ist der Anbieter berechtigt, alle Kundendaten endgültig zu löschen, soweit keine gesetzlichen Aufbewahrungspflichten entgegenstehen.</P>
          ...
          <S title="§ 16 Änderungen der AGB">
            <P>16.1 Der Anbieter ist berechtigt, diese AGB mit einer Ankündigungsfrist von mindestens 4 Wochen zu ändern. Die Änderungen werden dem Kunden per E-Mail mitgeteilt.</P>
            <P>16.2 Widerspricht der Kunde den Änderungen nicht innerhalb von 2 Wochen nach Zugang der Ankündigung, gelten die geänderten AGB als angenommen. Auf diese Rechtsfolge wird in der Ankündigung gesondert hingewiesen.</P>
          </S>
          ...
          <S title="§ 17 Schlussbestimmungen">
            ...
            <P>17.2 Erfüllungsort und ausschließlicher Gerichtsstand für alle Streitigkeiten ist, soweit gesetzlich zulässig, Bielefeld.</P>
            <P>17.3 Sollten einzelne Bestimmungen dieser AGB unwirksam sein oder werden, bleibt die Wirksamkeit der übrigen Bestimmungen unberührt.</P>
